...
- ## 第一章：变量与内存
  - __§1.__ 数据表示
  ![图 7](../images/bd8d12d9489a23009de507f99cff984a0fe13e7cf0493a2d642bf93855371123.png)  
  ...
  - 内存定义：内存可以以笔记本页的形式表示。 每个方格是一个存储单元。 每个单元格可以存储一些值（数字，符号等）。 对于该值所在的每个单元格，都分配了一个名称，我们可以通过该名称从程序的源代码访问该值。对于每一个包含值的单元格，我们都会分配一个名称，通过这个名称，我们可以从源码中访问该值。这就是代码与数据的交互方式。
   ...
   - __§3.__  常数
   ![图 2](../images/32027ad413050fdc851dd60894d6f01470c07efa2aa38dfbfe0cd94bb49ba63b.png)  
   ...
   - __§6.__ 运用“大数”
   ![图 5](../images/a7e78ce8b5745ccf52527993e7dcae73998e7f3715b595ecaccb2f7b4b36a268.png)  
   ...
   - __§8.__ 类型换算
   ![图 8](../images/601c42b85d73b6747e794fe8e956e330539196ea509890c221e9f3d86ecbaa5a.png)  
   ...
   - result = Math. _  (  _ _  ); имя функции аргументы через запяту
（逗号分隔的函数名参数）
   - 在这种情况下，结果可能是不同的类型，具体取决于所使用的功能。
   - __§12.__ 数学常数
   ![图 13](../images/07cd58ea9d8421821c2a0923367fd8d5149afc86341d5e5daf3ecc8718702cb1.png)  
   - 要在数学公式中使用诸如PI和E之类的常量，则无需在源代码中声明这些常量。这些常量在数学中声明
   - __§13.__ 行
   ![图 1](../images/28230703305c7be51966447699807d82915810324a3a2aedf7aa02853a4b96fb.png)  
   ...
   - __§16.__ 格式化输出
   ![图 1](../images/bf0358ba0eb88d376a5e04583c86110003062a0399ce6f0cee9976b2b3d088b9.png)  
   ...
   - __§17.__ 知而不做是愚蠢的，做而不知是危险的
   ![图 2](../images/5c0a7bfd8d82109131e657fd95158a566b8482571e793005ba408e45bbb7e872.png)  
   - 自测问题： 
        - 0.如果删除第13行的注释开头，会发生什么情况？
        - 1.解释为什么第7行的增量操作导致结果-128？
        - 2.将舍入结果转换为int类型的目的是什么？
   - __§18.__ 延续
   ![图 3](../images/17a42823fc8755e967076593313728fb7af0cc371d63f742112a29de880078f5.png)  
   - 在Java中实现数学公式的示例。
   - __§19.__ 延续
   ![图 4](../images/90ea388cee7051e95ff22fb0a6ed61e00d190316bbd5f4125809665f2582a2b8.png)  
   - 自测问题：
       - 1.在第17行执行构造后，输出是什么？
       - 2.在第15行找到错误；
       - 3.如果子字符串函数的参数更改为1和5，surName变量将等于什么？
   - __§20.__ 命令行参数
   ![图 5](../images/66361894f30117ccaa01a7de5c6f297fc73a354e682726ccea1766c2da34d798.png)  
   ...
   - __§21.__ 命令行参数
   ![图 1](../images/b56c848d5df0e268a72fe77df2ef0b24f3f5d8825ca3b22aa18d6812a62bbddc.png)  
   - 在第二行中，我们启动Java程序（Java虚拟机），并作为参数指定应包含应用程序入口点的类的名称-具有必要修饰符和签名的main方法。 为了将参数传递给我们的程序，我们将它们放在类名之后。 考虑在这种情况下会发生什么。
   - __§22.__ 命令行参数 ![图 2](../images/e30071a8a3b67b153606d1232102564b160806c8920c8de41fe59ca1087de587.png)  
   ...
   - __§23.__ 路径类与导入 ![图 3](../images/d686769e40f9aa02b9ab14060bd5ba64d84463053caac760a25a82d27e54d2e3.png)  
   ...
   - __§24.__ 路径类与导入
   ![图 1](../images/9d795b9b5401e0d32b53e17068c0fdb3884a5010b17518aca56dedc6a8cf268f.png)  
