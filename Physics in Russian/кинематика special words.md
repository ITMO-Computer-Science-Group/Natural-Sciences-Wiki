...
| что движется горизонтально с ускорением м/с² | что以加速度м/с²水平运动 |
| наклонный | 倾斜的 |
| на наклонной поверхности （клина） | 在（楔形）斜面上 |
| прикрепленный | 被固定的，被连接的 |
| вершина | 顶部，顶点 |
| упругий | 有弹性的 |
| шнур | 绳，软线 |
...
| прикрепленный к чему упругим шнуром с коэффициентом жесткости Н/м | 用一根劲度系数为Н/м的弹性绳连接在чему |
| максимальный | 最大的，最大限度的 |
| удлинение | 伸长 |
| состояние | 状态 |
| （не）растянутый | （未）拉长的 |
| максимальное удлинение шнура из нерастянутого состояния |弹性绳在未拉伸状态下的最大伸长量 |
