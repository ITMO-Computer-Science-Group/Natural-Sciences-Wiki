...
- 正弦
    ...
    $$x = \left\{ 
        \begin{aligned}
        &\arcsin\alpha+2\pi k,\\
        &\pi-\arcsin\alpha+2\pi k,k\in{Z}\end{aligned} \right.$$
    - $\sin{x}=0,x=k\pi,k\in{Z}$$
    - $\sin{x}=1,x=\frac{\pi}{2}+2k\pi,k\in{Z}$
    - $\sin{x}=-1,x=-\frac{\pi}{2}+2k\pi,k\in{Z}$
- 余弦
    - $\cos{x}=\alpha,x=\pm \arccos\alpha+2\pi k,k\in{Z}$
    - $\cos{x}=0,x=\frac{\pi}{2}+k\pi,k\in{Z}$
    - $\cos{x}=1,x=2k\pi,k\in{Z}$
    - $\cos{x}=-1,x=(2k+1)\pi,k\in{Z}$
- 正切
    - $\tg{x}=\alpha,(\cos{x}\neq0),x=\arctg\alpha+k\pi,k\in{Z}$
    - $\tg{x}=1,x=\frac{\pi}{4}+k\pi,k\in{Z}$
    - $\tg{x}=-1,x=-\frac{\pi}{4}+k\pi,k\in{Z}$ 
- 余切
    - $\ctg{x}=\alpha,(\sin{x}\neq0),x=\arcctg\alpha+k\pi,k\in{Z}$
    - $\ctg{x}=1,x=\frac{\pi}{4}+k\pi,k\in{Z}$
    - $\ctg{x}=-1,x=\frac{3}{4}\pi+k\pi,k\in{Z}$
