...
- 梯形：
    - 定义：如果 $BC$ 和 $AD$ 平行，四边形 $ABCD$ 称为梯形。
        - ![](../i/2021/06/11/hijtz8.png)
        - $AB$ 和 $CD$ - 侧边
        - $BC$ 和 $AD$ - 底边
    - 类别：
        - ![](../i/2021/06/11/i842y8.png)
            - 图132：等腰梯形
            - 图133：直角梯形
